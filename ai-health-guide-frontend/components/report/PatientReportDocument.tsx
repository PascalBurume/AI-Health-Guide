...
import { PatientReport, TriageColor } from "@/types/session";
...
export const PatientReportDocument = ({
  report,
  triageColor,
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.subtitle}>
          Generated on {new Date().toLocaleDateString()} — Language: {report.language.toUpperCase()}
        </Text>
